...
const StrokeText = ({
  ...
  useEffect(() => {
    ...
    if (typeof window === 'undefined' || !root || !box || !start) return undefined;
  ...
  }, [box, dash, drawDuration, fillDelay, stagger, ease, trigger, fillMode, reverse, start]);
  ...
  return (
    <span
      ...
      style={{ ...style, '--stroke-text-height': `${Math.round(fontSize * 1.15)}px` }}
      role="img"
